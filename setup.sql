...
) WITH CLUSTERING ORDER BY (flightid DESC, yearmonthday DESC, hourminutesecond ASC);
...
insert into flight (companyid, droneid, flightid, latitude, longitude, elevation, yearmonthday, hourminutesecond) values (1, 100500, 2, 100.3721216, 100.5227776, 101, '2020-05-01', '08:12:55');
